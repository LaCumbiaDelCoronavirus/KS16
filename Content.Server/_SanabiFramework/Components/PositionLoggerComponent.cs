...
/// <summary>
/// Component that stores a queue of the last <see cref="SharedPositionLoggingSystem.QueueCap"/> positions of an entity.
/// </summary>
[RegisterComponent, Access(typeof(PositionLoggingSystem))]
public sealed partial class PositionLoggerComponent : Component
{
    /// <summary>
    /// A queue with the maximum length of <see cref="SharedPositionLoggingSystem.QueueCap"/>.
